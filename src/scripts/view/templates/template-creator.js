    ...
    <div class="card">
        <div class="resto-item">
            <div class="resto-item__header">
                ...
                }" alt="restaurant ${name} image" class="resto1 lazyload">
            ...
            <div class="description">
                ...
                <h4 class="location">
                    <img src="./images/icon/map.png" alt="" width="20">  ${city}
                </h4>
...
<div id="detailRestoContainer">
    <div class="detailsResto">
        <div class="detail-resto">  
            ...
            }" alt="foto restaurant ${name}" class="img__resto">
        </div>
...
<div class="menu">
    <div class="menuList" id="menuList">
        <div id="menu-list-title">
            ...
            <img class="spoon" src="./images/icon/spoon.png" alt="icon spoon">
